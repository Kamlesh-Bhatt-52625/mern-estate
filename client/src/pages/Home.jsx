...
const Home = () => {
  ...
  useEffect(() => {
    const fectchOfferListings = async () => {
      try {
    ...
    <div>
      ...
      <div className='flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          Bhatt Estate specialize in turning your homeownership dreams into
          reality.
          <br />
          We have a diverse range of properties tailored to your unique
          preferences.
        </div>
        <Link
          to={"/search"}
